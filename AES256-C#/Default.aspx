...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:Label ID="Label1" runat="server" Width="200" Text="Text to encrypt (or key to decrypt):"></asp:Label>
    <asp:TextBox ID="Keyphrase" runat="server" Text="TextToEncrypt" Width="300"></asp:TextBox><br/>

 <asp:Label ID="Label2" runat="server"  Width="200"  Text="Passphrase:"></asp:Label>
    <asp:TextBox ID="Passphrase" runat="server" Text="test"  Width="300"></asp:TextBox><br/>

<asp:Label ID="Label3" runat="server"  Width="200"  Text="Salt:"></asp:Label>
    <asp:TextBox ID="Salt" runat="server" Text="4Bvq75DG" Width="300"></asp:TextBox><br/>

<asp:Label ID="Label4" runat="server"  Width="200"  Text="Iterations:"></asp:Label>
    <asp:TextBox ID="Iterations" runat="server" Text="1000" Width="300"></asp:TextBox><br/>

<asp:Label ID="Label5" runat="server"  Width="200"  Text="Init Vector:"></asp:Label>
    <asp:TextBox ID="InitVector" runat="server" Text="pOWaTbO92LfXbh69JkYzfT7P465TNc0h" Width="300"></asp:TextBox><br/>

    <asp:Label ID="Label6" runat="server"  Width="200"  Text="Keysize:"></asp:Label>
    <asp:TextBox ID="Keysize" runat="server" Text="256"  Width="300"></asp:TextBox><br /><br />
